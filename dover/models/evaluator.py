    ...
    def __init__(
        ...
        if divide_head:
            ...
            if var:
                ...
                self.vqa_head = VQAHead(**vqa_head)
#forward: Processes video clips (vclips) through the respective 
# backbone and head, and calculates the score for each backbone.
    def forward(
        self,
        vclips,
        inference=True,
        ...
        **kwargs
        ...
        if inference:
            ...
            if return_pooled_feats:
                return scores, feats
            return scores
 #forward_head: Processes already computed features (feats) with the head to get a final score.       
    def forward_head(
        self,
        feats,
        inference=True,
