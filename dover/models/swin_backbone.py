...
class WindowAttention3D(nn.Module):
    ...
    This class implements the window-based self-attention mechanism for 3D Swin Transformers.
...
class SwinTransformerBlock3D(nn.Module):
    ...
    This class in the provided code implements a single block of the Swin Transformer
    architecture for 3D data. It combines local self-attention within windows and a 
    shifted windowing mechanism, along with normalization and feedforward layers
    Args:
        dim (int): Number of input channels.
        num_heads (int): Number of attention heads.
        window_size (tuple[int]): Window size.
...
class in the code represents a single stage in the hierarchical Swin Transformer architecture. 
It combines multiple Swin Transformer blocks, handles window-based attention, and manages patch merging 
(downsampling) between stages. This class enables scalable feature extraction at various resolutions
by applying self-attention and downsampling systematically.
    Args:
